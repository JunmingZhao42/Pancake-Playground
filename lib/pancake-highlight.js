    ...
    this.$rules = {
      "start": [
        ...
        },
        {
          ...
          regex: "\\b(?:var|skip|stw|ldw|st8|ld8|st32|ld32|st|lds|if|else|while|break|continue|raise|return|tick|in|with|handle|!st8|!st32|!st16|ld16|goto|label|domain|axiom)\\b"
        },
        {
